...
@borg.on(admin_cmd(pattern=r"helpp ?(.*)", outgoing=True))
@borg.on(sudo_cmd(pattern=r"helpp ?(.*)", outgoing=True, allow_sudo=True))
...
@bot.on(admin_cmd(outgoing=True, pattern="in ?(.*)"))
@bot.on(sudo_cmd(pattern="in ?(.*)", allow_sudo=True))
