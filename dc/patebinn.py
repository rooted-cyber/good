...
@bot.on(admin_cmd(pattern="dog( (.*)|$)", outgoing=True))
...
@bot.on(admin_cmd(pattern="nek( (.*)|$)", outgoing=True))
@bot.on(sudo_cmd(pattern="nek( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(admin_cmd(pattern="iffuciaa( (.*)|$)", outgoing=True))
@bot.on(sudo_cmd(pattern="iffuciaa( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    catevent = await edit_or_reply(event, "`pasting to del dog.....`")
...
@bot.on(admin_cmd(outgoing=True, pattern="getdog( (.*)|$)"))
@bot.on(sudo_cmd(allow_sudo=True, pattern="getdog( (.*)|$)"))
...
@bot.on(admin_cmd(pattern="dog2( (.*)|$)", outgoing=True))
@bot.on(sudo_cmd(pattern="dog2( (.*)|$)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    catevent = await edit_or_reply(event, "`pasting to del dog.....`")
