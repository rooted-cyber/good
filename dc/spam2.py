...
@bot.on(admin_cmd(pattern="spam2 (.*)"))
@bot.on(sudo_cmd(pattern="spam2 (.*)", allow_sudo=True))
async def spammer(e):
    if e.fwd_from:
        return
    await e.get_chat()
...
@bot.on(admin_cmd(pattern="bigspam2 (.*)"))
@bot.on(sudo_cmd(pattern="bigspam2 (.*)", allow_sudo=True))
async def spammer(e):
    if e.fwd_from:
        return
    await e.get_chat()
...
@bot.on(admin_cmd("cspam2 (.*)"))
@bot.on(sudo_cmd(pattern="cspam2 (.*)", allow_sudo=True))
async def tmeme(e):
...
@bot.on(admin_cmd("wspam2 (.*)"))
@bot.on(sudo_cmd(pattern="wspam2 (.*)", allow_sudo=True))
async def tmeme(e):
...
@bot.on(admin_cmd("delayspam2 (.*)"))
@bot.on(sudo_cmd(pattern="delayspam2 (.*)", allow_sudo=True))
async def spammer(e):
    if e.fwd_from:
        return
...
CMD_HELP.update(
    {
        "spam": "**Plugin : **`spam`\
        \n\n**Syntax : **`.spam2 <count> <text>`\
        \n**Function : **__ Floods text in the chat !!__\
        \n\n**Syntax : **`.spam2 <count> reply to media`\
        \n**Function : **__Sends the replied media <count> times !!__\
        \nFor above two commands use \n`.bigspam2` instead of spam for spamming more than 50 messages\
        \n\n**Syntax : **`.cspam2 <text>`\
        \n**Function : **__ Spam the text letter by letter.__\
        \n\n**Syntax : **`.wspam <text>`\
        \n**Function : **__ Spam2 the text word by word.__\
        \n\n**Syntax : **`.delayspam2 <delay> <count> <text>`\
